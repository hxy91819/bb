...
| `fix/local-aggregate-service-tier-migration` | `c6a69e157` | `9f460e6bb` | [#3403](https://github.com/get-bb/bb/issues/3403) | 在本地旧 Fast 列已存在而 canonical 台账未记录时，暂存并恢复该值以完成标准迁移序列 |

...
| `fix/local-aggregate-service-tier-migration` | `5bca4e8f1` | `6cb7fd820` | [#3403](https://github.com/get-bb/bb/issues/3403) | 兼容旧 Fast 列及其较晚迁移时间戳，使 canonical Fast 与 UI 设置迁移完整重放 |

...
This document records the upstream feedback associated with independently maintained changes in `local/aggregate`. It is a contribution log, not the authoritative specification backlog: new specifications belong in the personal fork at `hxy91819/bb`.

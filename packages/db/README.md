...
the stable release's machine-provider and thread-plugin-metadata migrations.
Startup replays those skipped migrations and preserves existing activity values while applying the

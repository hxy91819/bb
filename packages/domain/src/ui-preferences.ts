...
export const UI_PREFERENCE_STRING_MAX_LENGTH = 1_024;
export const UI_PREFERENCE_LIST_MAX_LENGTH = 10_000;

export const sidebarOrganizationModeSchema = z.enum([
  "project",
  "chronological",
  "machine",
]);
...
export const sidebarChronologicalSortSchema = z.enum([
  "updated",
  "created",
  "alpha",
  "none",
...
export const collapsibleSidebarSectionIdSchema = z.enum(["pinned", "threads"]);
...
export const uiPreferenceKeySchema = z.enum(UI_PREFERENCE_KEYS);
...
export const uiPreferenceEntrySchema = z
  .object({
